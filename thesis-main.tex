...
\lstdefinelanguage{yaml}{
  ...
  basicstyle=\ttfamily\small,                                 % assuming a key comes first
  sensitive=false,
  comment=[l]{\#},
  morecomment=[s]{/*}{*/},
...
In this project, \textbf{GitHub Actions} is used as the \ac{CI} platform to automate the build processes for both the shared codebase and the mobile application.
...
The algorithm was added to \footnote{\url{https://github.com/Collektive/collektive-examples}}, repository which hosts various examples of applications built using the Collektive framework.
