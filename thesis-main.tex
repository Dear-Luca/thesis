...
\begin{itemize}
    ...
    It provides a \ac{DSL} and API modules for writing, testing, and running aggregate programs.
    ...
    The high-level architecture of ScaFi is depicted in \Cref{fig:scafi-architecture}.
