...
It supports multiple concurrent message sources and includes configurable parameters such as message expiration time and maximum propagation distance to control dissemination scope.

The messaging logic is integrated into Echo, a cross-platform mobile application (Android/iOS) developed with Kotlin Multiplatform and Jetpack Compose Multiplatform for the user interface. The application currently employs the MQTT protocol as the transport layer for inter-device communication.
...
Future developments will focus on integrating peer-to-peer communication protocols, such as Bluetooth or Wi-Fi Direct, to achieve a fully decentralized architecture.
\end{abstract}
