...
In this section, it will be presented the state of the art in the field of decentralized communication systems.
 The focus will be on the main existing systems, aggregate computing frameworks, and lightweight \ac{P2P} protocols that enable infrastructure-less connectivity.
...
The software that has spread the most and gained significant attention includes: Briar, Bridgefy, FireChat.
\subsubsection{Briar}
...
It supports multiple transport methods including Bluetooth, Wi-Fi, Tor, and removable storage (USB sticks), with all communication end-to-end encrypted.
...
Bridgefy implements encryption protocols to secure message transmission, though the specific implementation has evolved across different versions of the platform.
