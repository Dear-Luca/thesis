...
\begin{itemize}
    ...
    \lstinputlisting[float, language=Kotlin, label={lst:GPS-heartbeat-code}, caption={GPS coordinates embedded inside the heartbeat payload.}]{listings/DeviceLocationHeartbeat.kt}
