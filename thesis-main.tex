...
Messages originate from \textbf{source nodes} and spread through the network using the aggregate gossip-gradient algorithm.
...
\textbf{Compose Multiplatform} is the UI framework used to implement the graphical interface of the application on both Android and iOS. 
...
In this project, Compose Multiplatform has been adopted to design the messaging application’s graphical interface, allowing users to create, send, and visualize
